...
with col_a:
    st.info(f"**Next Trade Amount:** ৳{ (data['base_amount'] if data['current_step']==1 else (data['trade_history'][-1]['trade_amount'] + data['trade_history'][-1]['profit'] if data['trade_history'] else data['base_amount'])) :,.2f}")
with col_b:
