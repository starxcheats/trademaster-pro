...
if 'data' not in st.session_state:
    ...
    if saved:
        ...
        st.session_state.data = {
            ...
            'compound_steps': 3,
            'payout_pct': 90.0,
            'profit_target_pct': 13.0,      # Changed to Percentage
            'loss_target_pct': 15.0,        # Changed to Percentage
            'current_step': 1,
            'current_cycle': 1,
            'trade_history': [],
            'locked': False,
...
data['profit_target_pct'] = st.sidebar.number_input("Daily Profit Target (%)", value=data.get('profit_target_pct', 13.0), step=1.0)
data['loss_target_pct'] = st.sidebar.number_input("Daily Loss Target (%)", value=data.get('loss_target_pct', 15.0), step=1.0)
